export declare const TAGS: readonly ["div", "span", "p", "h1", "h2", "h3", "h4", "h5", "h6", "section", "main", "header", "footer", "nav", "button", "input", "label", "ul", "li", "a", "img", "i", "form", "br", "strong", "small", "canvas", "table", "thead", "tbody", "tr", "th", "td", "select", "option", "iframe"];
